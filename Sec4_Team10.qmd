...
To address the research questions, we used descriptive statistics to summarize suicide and overdose rates across demographic groups, visualization (e.g., bar chart, heatmap) to explore patterns and disparities, and correlation analysis to evaluate potential relationships between suicide and drug overdose rates.

## FAIR Principle 

The datasets used in this study follow the FAIR principles, meaning they are findable, accessible, interoperable, and reusable. They are easy to find on Data.gov, a platform that organizes and shares public data. The data can be downloaded in simple formats like CSV, which works with most tools for analysis. It also includes clear information about how the data was collected and structured, making it easier for others to use and build on. Following these principles ensures the data is easy to understand, share, and use for future research.
